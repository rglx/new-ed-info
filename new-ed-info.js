// ED Info Discord Bot
// by CMDR DJ Arghlex
// version 3 changes by Willyb321
// DEPENDENCIES
...
const fchar = '\uD83C\uDDEB';
const botName = 'New E:D Info by DJ Arghlex & willyb321';
// FUNCTIONS
...
bot.on( 'message', ( user, userId, channelId, message, event ) => {
	...
	if (command == configuration.commandPrefix + "ping") { // send a message to the channel as a ping-testing thing.
		...
		if ( userId.toString() === configuration.adminUserId ) {
			returnedEmbedObject.fields.push( {
				name: configuration.commandPrefix + '__**Administrative Commands**__'
